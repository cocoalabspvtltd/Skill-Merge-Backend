            ...
            <div class="card-body">
                <form action="{{ route('testimonials.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-rounded" id="client_data" name="client_data" placeholder="Enter Client Data" style="color: black !important;">
                    </div>


                    <div class="form-group">
                        <label for="client_image">Client Image</label>
                        <input type="file" class="form-control form-control-rounded" id="client_image" name="client_image" onchange="previewImage(event)">
                        <br>
