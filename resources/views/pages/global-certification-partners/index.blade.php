<x-app-layout>
    <div class="col-lg-12">
        <br>
        <h2>Global Certification Partners</h2>
        <a href="{{ route('global-certification-partners.create') }}" class="btn btn-primary btn-sm" style="float:right; margin-top: -36px;">Add</a>
        <br>
        <div class="card">
            <div class="card-body">
                @if ($data->isEmpty())
